                            ...
                            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
                                <div class="bpa-customize-step-side-panel">
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls" >
                                        <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls">
                                            <div class="bpa-sm--item">
                                                <label class="bpa-form-label"><?php esc_html_e('Appointment reschedule Page', 'bookingpress-appointment-booking'); ?></label>
                                                <el-select v-model="my_booking_field_settings.appointment_reschedule_page" class="bpa-form-control" filterable popper-class="bpa-el-select--is-with-navbar bpa-el-select--is-customize-left-panel">
                                                    <el-option v-for="item in bookingpress_all_global_pages" :key="item.post_title" :label="item.post_title"  :value="''+item.ID"></el-option>
                                                </el-select>
                                            </div>
                                        </div>
